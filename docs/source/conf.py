...
autodoc_mock_imports = [
    ...
    'warnings',
    'tifffile',
    'tomocupy_stream.cfunc_fourierrec',
    'tomocupy_stream.cfunc_fourierrecfp16',
    'tomocupy_stream.cfunc_lprec',
    'tomocupy_stream.cfunc_lprecfp16',
    'tomocupy_stream.cfunc_filter',
    'tomocupy_stream.cfunc_filterfp16',    
    'tomocupy_stream.cfunc_linerec',    
    'tomocupy_stream.cfunc_linerecfp16',]
