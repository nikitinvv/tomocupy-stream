...
theta = np.linspace(0,180,512).astype('float32')
obj = dxchange.read_tiff('delta-chip-256.tiff')#[:,64:-64,64:-64]
...
print(np.sum(data_reproj*data_reproj))
print(np.sum(obj*obj_reproj))
